...
class GetPostBloc extends Bloc<GetPostEvent, GetPostState> {
  ...
  final ConnectivityService connectivityService;
    ...
    GetPostBloc({required this.getpostUseCase,required this.connectivityService}) : super(GetPostInitialState()) {
      on<GetPostEvent>((event, emit) async {
        if(event is FetchPostEvent) {
          ...
          try {
            ...
            List<PostModel> posts = await getpostUseCase!.execute(isConnected);
